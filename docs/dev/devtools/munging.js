...
var temp__5821__auto__ = (function (){var temp__5821__auto__ = (devtools.munging.get_global_scope.call(null)["cljs"]);
if(cljs.core.truth_(temp__5821__auto__)){
var o13052 = temp__5821__auto__;
var temp__5821__auto____$1 = (o13052["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o13053 = temp__5821__auto____$1;
return (o13053["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5821__auto__)){
var js_reserved_fn = temp__5821__auto__;
...
var o__12410__auto__ = f;
return (o__12410__auto__["toString"]).call(o__12410__auto__);
} else {
return "";
}
}catch (e13054){var _ = e13054;
return "";
}});
...
try{var o__12410__auto___13056 = t;
(o__12410__auto___13056["cljs$lang$ctorPrWriter"]).call(o__12410__auto___13056,t,writer);
}catch (e13055){var __13057 = e13055;
}
...
var char_code = (function (){var o__12410__auto__ = (new String(char$));
return (o__12410__auto__["charCodeAt"]).call(o__12410__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12410__auto__ = String;
return (o__12410__auto__["fromCharCode"]).call(o__12410__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13058 = num_code;
switch (G__13058) {
case (1):
return (185);
...
var o__12410__auto__ = String;
return (o__12410__auto__["fromCharCode"]).call(o__12410__auto__,superscript_code);
});
/**
...
var temp__5821__auto__ = cljs.core.second.call(null,cljs.core.re_find.call(null,/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5821__auto__)){
var meat = temp__5821__auto__;
var temp__5821__auto____$1 = cljs.core.re_find.call(null,/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5821__auto____$1)){
var match = temp__5821__auto____$1;
...
}catch (e13060){var _e__12417__auto__ = e13060;
return false;
}})())){
...
var vec__13061 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13061,(0),null);
...
var or__5002__auto__ = (function (){var temp__5821__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5821__auto__)){
...
var temp__5825__auto__ = devtools.munging.goog$module$goog$object.getValueByKeys.call(null,devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5825__auto__ == null)){
return null;
} else {
var ns_obj = temp__5825__auto__;
...
var G__13072 = (i__5727__auto___13071 + (1));
i__5727__auto___13071 = G__13072;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13066){
var vec__13067 = p__13066;
var ns_detector = cljs.core.nth.call(null,vec__13067,(0),null);
...
var G__13073 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13074 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13073;
remaining_tokens = G__13074;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13064){
var G__13065 = cljs.core.first.call(null,seq13064);
var seq13064__$1 = cljs.core.next.call(null,seq13064);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13065,seq13064__$1);
}));
...
var vec__13078 = cljs.core.split_with.call(null,(function (p1__13077_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13077_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13078,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13078,(1),null);
...
var vec__13084 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13084,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13084,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13087 = cljs.core.rest.call(null,remaining_tokens);
var G__13088 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13087;
name_tokens = G__13088;
continue;
} else {
...
var vec__13091 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13091,(0),null);
var arity = cljs.core.nth.call(null,vec__13091,(1),null);
var vec__13094 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13094,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13094,(1),null);
var vec__13097 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13097,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13097,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13097,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13097,(3),null);
...
var vec__13103 = result;
var munged_ns = cljs.core.nth.call(null,vec__13103,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13103,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13103,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13103,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13103,(4),null);
var arity = cljs.core.nth.call(null,vec__13103,(5),null);
...
var temp__5821__auto__ = devtools.munging.parse_fn_source.call(null,fn_source);
if(cljs.core.truth_(temp__5821__auto__)){
var vec__13107 = temp__5821__auto__;
var munged_name = cljs.core.nth.call(null,vec__13107,(0),null);
var args = cljs.core.nth.call(null,vec__13107,(1),null);
var vec__13110 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13110,(0),null);
var name = cljs.core.nth.call(null,vec__13110,(1),null);
...
var temp__5821__auto__ = cljs.core.get.call(null,state,prefix);
if(cljs.core.truth_(temp__5821__auto__)){
var subscript = temp__5821__auto__;
...
var G__13113 = (arity + (1));
var G__13114 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
var arity_fn = temp__5821__auto__;
...
var temp__5821__auto__ = devtools.munging.get_fn_variadic_arity.call(null,f);
if(cljs.core.truth_(temp__5821__auto__)){
var variadic_arity = temp__5821__auto__;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13115){
var vec__13116 = p__13115;
var arity = cljs.core.nth.call(null,vec__13116,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13116,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__5002__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13119_SHARP_){
return cljs.core.get.call(null,arities,p1__13119_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13120_SHARP_){
return cljs.core.drop.call(null,(2),p1__13120_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___13127 = arguments.length;
var i__5727__auto___13128 = (0);
while(true){
if((i__5727__auto___13128 < len__5726__auto___13127)){
args__5732__auto__.push((arguments[i__5727__auto___13128]));

var G__13129 = (i__5727__auto___13128 + (1));
i__5727__auto___13128 = G__13129;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13123){
var vec__13124 = p__13123;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13124,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13121){
var G__13122 = cljs.core.first.call(null,seq13121);
var seq13121__$1 = cljs.core.next.call(null,seq13121);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13122,seq13121__$1);
}));
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__5002__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[(cljs.core.truth_((function (){var or__5002__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var map__13132 = options;
var map__13132__$1 = cljs.core.__destructure_map.call(null,map__13132);
var include_ns_QMARK_ = cljs.core.get.call(null,map__13132__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13132__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13132__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13132__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13133 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13133,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13133,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13133,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13133,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13133,(4),null);
var arity = cljs.core.nth.call(null,vec__13133,(5),null);
...
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not.call(null,(function (){var and__5000__auto____$1 = silence_common_protocols_QMARK_;
...
var o__12410__auto__ = f;
return (o__12410__auto__["getBasis"]).call(o__12410__auto__);
});
/**
...
}catch (e13136){var _e__12417__auto__ = e13136;
...
var G__13137 = (obj[cljs.core.first.call(null,path)]);
var G__13138 = cljs.core.rest.call(null,path);
obj = G__13137;
path = G__13138;
continue;
} else {
...
var temp__5821__auto__ = cljs.core.re_matches.call(null,/(.*)\$$/,key);
if(cljs.core.truth_(temp__5821__auto__)){
var m = temp__5821__auto__;
...
var _STAR_ = (function (accum,p__13139){
var vec__13140 = p__13139;
var bit = cljs.core.nth.call(null,vec__13140,(0),null);
var protocol = cljs.core.nth.call(null,vec__13140,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13143){
var vec__13144 = p__13143;
var ns = cljs.core.nth.call(null,vec__13144,(0),null);
var name = cljs.core.nth.call(null,vec__13144,(1),null);
var selector = cljs.core.nth.call(null,vec__13144,(2),null);
...
var post_process = (function (p__13148){
var vec__13149 = p__13148;
var munged_name = cljs.core.nth.call(null,vec__13149,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13149,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13147_SHARP_){
return (obj[cljs.core.first.call(null,p1__13147_SHARP_)]);
}),sorted_matches);
