...
return cljs.core.reduce.call(null,(function (result,p__13285){
...
var vec__13289 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__13289,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__13289,(1),null);
var ab = cljs.core.nth.call(null,vec__13289,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_13295 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_13295.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_13296 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_13296.call(null,a,b);
}
});
...
return (function (){var G__13300 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13300__$1)].join('')));
