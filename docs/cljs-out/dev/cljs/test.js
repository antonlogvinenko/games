...
var G__11805 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11805,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11805;
}
}));
...
var len__5726__auto___11810 = arguments.length;
var i__5727__auto___11811 = (0);
while(true){
if((i__5727__auto___11811 < len__5726__auto___11810)){
args__5732__auto__.push((arguments[i__5727__auto___11811]));

var G__11812 = (i__5727__auto___11811 + (1));
i__5727__auto___11811 = G__11812;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11807){
var G__11808 = cljs.core.first.call(null,seq11807);
var seq11807__$1 = cljs.core.next.call(null,seq11807);
var G__11809 = cljs.core.first.call(null,seq11807__$1);
var seq11807__$2 = cljs.core.next.call(null,seq11807__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11808,G__11809,seq11807__$2);
}));
...
var map__11814 = m;
var map__11814__$1 = cljs.core.__destructure_map.call(null,map__11814);
var file = cljs.core.get.call(null,map__11814__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11814__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11814__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11813_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11813_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__5599__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__5002__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var temp__5823__auto___11815 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___11815)){
var message_11816 = temp__5823__auto___11815;
cljs.core.println.call(null,message_11816);
} else {
}
...
var temp__5823__auto___11817 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___11817)){
var message_11818 = temp__5823__auto___11817;
cljs.core.println.call(null,message_11818);
} else {
}
...
var output_dir = "target/public/cljs-out/dev";
var output_dir__$1 = (function (){var G__11819 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11819,"/"].join('');
} else {
return G__11819;
}
})();
...
var temp__5821__auto__ = new cljs.core.Keyword(null,"source-map","source-map",1706252311).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(temp__5821__auto__)){
var source_map = temp__5821__auto__;
var temp__5821__auto____$1 = cljs.core.get_in.call(null,source_map,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [filename,(line - (1))], null));
if(cljs.core.truth_(temp__5821__auto____$1)){
var columns = temp__5821__auto____$1;
return cljs.core.vec.call(null,cljs.core.map.call(null,cljs.core.first.call(null,(function (){var temp__5821__auto____$2 = cljs.core.get.call(null,columns,(column - (1)));
if(cljs.core.truth_(temp__5821__auto____$2)){
var mapping = temp__5821__auto____$2;
return mapping;
} else {
...
var temp__5821__auto__ = (function (){var and__5000__auto__ = typeof exception.stack === 'string';
if(and__5000__auto__){
var G__11820 = exception.stack;
var G__11820__$1 = (((G__11820 == null))?null:clojure.string.split_lines.call(null,G__11820));
var G__11820__$2 = (((G__11820__$1 == null))?null:cljs.core.get.call(null,G__11820__$1,depth));
if((G__11820__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11820__$2);
}
} else {
...
if(cljs.core.truth_(temp__5821__auto__)){
var stack_element = temp__5821__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11821 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11821,(0),null);
var column = cljs.core.nth.call(null,vec__11821,(1),null);
var vec__11824 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11824,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11824,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11824,(2),null);
...
var m__$1 = (function (){var G__11827 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11827__$1 = (((G__11827 instanceof cljs.core.Keyword))?G__11827.fqn:null);
switch (G__11827__$1) {
case "fail":
...
while(true){
var temp__5823__auto__ = cljs.core.seq.call(null,fns);
if(temp__5823__auto__){
var xs__6383__auto__ = temp__5823__auto__;
var f = cljs.core.first.call(null,xs__6383__auto__);
var obj = f.call(null);
if(cljs.test.async_QMARK_.call(null,obj)){
return obj.call(null,(function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6383__auto__,temp__5823__auto__){
return (function (){
return cljs.test.run_block.call(null,cljs.core.rest.call(null,fns));
});})(fns,obj,f,xs__6383__auto__,temp__5823__auto__))
,null));
return ((function (fns,d,obj,f,xs__6383__auto__,temp__5823__auto__){
return (function (){
...
;})(fns,d,obj,f,xs__6383__auto__,temp__5823__auto__))
})());
} else {
var G__11831 = (function (){var G__11830 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11830);
} else {
return G__11830;
}
})();
...
return cljs.core.vary_meta.call(null,G__11832,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__11834 = e;
var G__11834__$1 = (((G__11834 instanceof cljs.core.Keyword))?G__11834.fqn:null);
switch (G__11834__$1) {
...
var temp__5821__auto__ = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5821__auto__)){
...
var vec__11836 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11836,(0),null);
var types = vec__11836;
...
return cljs.core.map.call(null,(function (p__11839){
var vec__11840 = p__11839;
var ns = cljs.core.nth.call(null,vec__11840,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11840,(1),null);
return (function (){
...
var G__11843 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11843__$1 = (((G__11843 instanceof cljs.core.Keyword))?G__11843.fqn:null);
switch (G__11843__$1) {
case "async":
...
var seq__11844 = cljs.core.seq.call(null,vars__$1);
var chunk__11845 = null;
var count__11846 = (0);
var i__11847 = (0);
while(true){
if((i__11847 < count__11846)){
var v = cljs.core._nth.call(null,chunk__11845,i__11847);
var temp__5823__auto___11849 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___11849)){
var t_11850 = temp__5823__auto___11849;
each_fixture_fn.call(null,((function (seq__11844,chunk__11845,count__11846,i__11847,t_11850,temp__5823__auto___11849,v,each_fixture_fn,G__11843,G__11843__$1,env,once_fixtures,each_fixtures,vec__11840,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11850)));
});})(seq__11844,chunk__11845,count__11846,i__11847,t_11850,temp__5823__auto___11849,v,each_fixture_fn,G__11843,G__11843__$1,env,once_fixtures,each_fixtures,vec__11840,ns,vars__$1))
);
} else {
}


var G__11851 = seq__11844;
var G__11852 = chunk__11845;
var G__11853 = count__11846;
var G__11854 = (i__11847 + (1));
seq__11844 = G__11851;
chunk__11845 = G__11852;
count__11846 = G__11853;
i__11847 = G__11854;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq.call(null,seq__11844);
if(temp__5823__auto__){
var seq__11844__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11844__$1)){
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__11844__$1);
var G__11855 = cljs.core.chunk_rest.call(null,seq__11844__$1);
var G__11856 = c__5525__auto__;
var G__11857 = cljs.core.count.call(null,c__5525__auto__);
var G__11858 = (0);
seq__11844 = G__11855;
chunk__11845 = G__11856;
count__11846 = G__11857;
i__11847 = G__11858;
continue;
} else {
var v = cljs.core.first.call(null,seq__11844__$1);
var temp__5823__auto___11859__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___11859__$1)){
var t_11860 = temp__5823__auto___11859__$1;
each_fixture_fn.call(null,((function (seq__11844,chunk__11845,count__11846,i__11847,t_11860,temp__5823__auto___11859__$1,v,seq__11844__$1,temp__5823__auto__,each_fixture_fn,G__11843,G__11843__$1,env,once_fixtures,each_fixtures,vec__11840,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11860)));
});})(seq__11844,chunk__11845,count__11846,i__11847,t_11860,temp__5823__auto___11859__$1,v,seq__11844__$1,temp__5823__auto__,each_fixture_fn,G__11843,G__11843__$1,env,once_fixtures,each_fixtures,vec__11840,ns,vars__$1))
);
} else {
}


var G__11861 = cljs.core.next.call(null,seq__11844__$1);
var G__11862 = null;
var G__11863 = (0);
var G__11864 = (0);
seq__11844 = G__11861;
chunk__11845 = G__11862;
count__11846 = G__11863;
i__11847 = G__11864;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11843__$1)].join('')));
