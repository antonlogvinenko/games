window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=e89258&fwbuild=dev"};
...
document.write('<script>goog.require("learn_cljs.contacts");</script>');
